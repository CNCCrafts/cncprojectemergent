...
async function seedIfEmpty() {
  ...
  const seed = [
    ...
    { name: 'Personalized Pen Stand',     category: 'gifting', price: 799,  offer_price: 699, description: 'Elegant pen stand crafted for desks, office gifting and executive welcome kits.',                  image: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&q=80', image_id: '', stock: 18, active: true, created_at: now },
  ];
