...
export default function Home() {
  ...
  return (
    <main className="home-page">
      ...
      {/* ── Gifting spotlight ─────────────────────────────────────────── */}
      <section className="section gifting-spotlight">
        <div className="container">
          <div className="gifting-hero gifting-hero--compact">
            <div className="gifting-hero__content">
              <span className="eyebrow" style={{ color: '#B97C57', marginBottom: 10 }}>Thoughtful gifting</span>
              <h2 className="gifting-hero__title">Elegant keepsakes for birthdays, anniversaries and office appreciation.</h2>
              <p className="gifting-hero__text">Discover personalised pen stands, desk accents and more — crafted to feel premium from the first glance.</p>
              <div className="hero__actions" style={{ justifyContent: 'center', marginTop: 18 }}>
                <Link to="/categories#gifting" className="btn-primary">Explore gifting</Link>
              </div>
            </div>
          </div>
        </div>
