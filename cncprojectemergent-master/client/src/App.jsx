...
function AppShell() {
  ...
  useEffect(() => {
    const accepted = localStorage.getItem('cnc-cookie-consent');
    if (!accepted) {
  ...
  const acceptCookies = () => {
    localStorage.setItem('cnc-cookie-consent', 'accepted');
    setCookieOpen(false);
  };
    ...
    <>
      ...
      <div className="page-wrapper flex flex-col min-h-screen">
        ...
        <Routes>
          ...
          <Route path="/refund" element={<Policies type="refund" />} />
          ...
          <div className="cookie-banner">
            <div className="container cookie-banner__inner">
              <div>
                ...
                <p>By continuing to browse, you agree to our use of cookies for site functionality and analytics.</p>
              </div>
              <button className="cookie-banner__btn" onClick={acceptCookies}>Accept</button>
            </div>
          </div>
        )}
